...
def query_weppcloud_hillslopes_monthlies(runid, cap=20):
    import duckdb
...
if __name__ == "__main__":
    ...
    t0 = time()
    monthlies = query_weppcloud_hillslopes_monthlies('featured-reach', cap=2000)
    t1 = time() - t0
    print(f"Time: {t1:.2f} seconds, {t1/len(monthlies):.2f} seconds per location")
    print()
